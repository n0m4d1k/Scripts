# This script was taken from https://rohnspowershellblog.wordpress.com/2013/03/19/viewing-service-acls/
# and is being stored in the event it is no longer available on the original site.
