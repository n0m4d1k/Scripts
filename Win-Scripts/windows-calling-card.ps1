###################################################################################################
#                                      |                                                          #
# Title: Calling-Card                  |               `L.                      `L`               #
# Author: N0m4d1k                      |              ,QQQ~                    ,QQQ~              #
# Props: I am Jakoby                   |             ^@* ;@|                  +@= ^@*             #
# Version: 1.0                         |           `fQ,   .Qk`              `yQ'   .Qw`           #
# Category: General                    |          'WK`      aQ:            '#6       wQ,          #
# Target: Windows 10, 11               |         ^@i         ^@|          ^@|         =@<         #
# Mode: HID                            |        tQ,           'QZ`      `uQ,           'Qy`       #
#                                      |      'RR`              kQ,    'gD               6#,      #
#                                      |     ;Qz                 <@>  !@\                 |@+     #
#                                      |    i@~                   '@j7@_                   ,@Y    #
#                                      |    'NK`                  yQ~,BU                   ZQ:    #
...
#                                      |        'Qk           uQ~        ,Qw           jQ:        #
# github.com/n0m4d1k                   |         `ZQ'       `8b.          `wQ'       .#q`         #
# twitter.com/n0m4d1k                  |           >@<     ;@v              *@+     ;@i           #
# instagram.com/n0m4d1k                |            ,Qa   7Q~                ,Qy   tQ~            #
#                                      |             `kQ,RR.                  `6B,gD.             #
#                                      |               |@x                      L@z               #
#                                      |                .                        .                #
#                                      |                                                          #                                      |                       Shhhhhhhhhhh                       #
...
$hiddenMessage = "N0m4d1k was here"
